...
gcloud container --project "exalted-beanbag-334502" clusters create "cloud-mesh-16x16" \
    --zone "us-west1-b" \
...
gcloud container clusters get-credentials --zone us-west1-b cloud-mesh-16x16
