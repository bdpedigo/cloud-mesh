...
from meshmash import interpret_path
...
def run_for_root(
    ...
    if morphology._mesh is not None:
        ...
        timing_dict["pull_mesh_synapse_time"] = synapse_time
...
if REQUEST:
    ...
    if True:
        ...
        # tasks += [
        #     partial(run_for_root, root_id, datastack, 0) for root_id in root_ids
        # ]
        ...
        tasks += [partial(run_for_root, root_id, datastack, 0) for root_id in root_ids]
        print(len(tasks))
